# Networking basics #0
Basic concept of network was introduced in this project. Eg. OSI model, LAN and WAN networks, and TCP/UDP data transfer protocols were coverd in a mutiple choice questions
